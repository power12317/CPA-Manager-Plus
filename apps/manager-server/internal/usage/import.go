...
func eventFromLegacyDetail(
	...
	event := Event{
		...
		TurnID:                        readString(detail, "turn_id", "turnId"),
		System:                        readCodexSystem(detail),
		TurnStateLen:                  readString(detail, "turn_state_len", "turnStateLen"),
		OailbNode:                     NormalizeOailbNode(readString(detail, "oailb_node", "oailbNode")),
